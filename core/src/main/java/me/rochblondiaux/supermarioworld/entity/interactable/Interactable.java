...
public abstract class Interactable extends Entity {
    ...
    protected final AnimationController<Interactable> animations;

    public Interactable(Level level, EntityType type, Body body, RectangleMapObject source, String atlasPath) {
